...
def driver (name, iters, vec_len, port):
  ...
  # drinks (cans)
  cm.coke = cm.msg["contents"]["drinks"]["cans"]["coke"] = random.randint(1,10)
  cm.beer = cm.msg["contents"]["drinks"]["cans"]["beer"] = random.randint(1,10)
  cm.rootbeer = cm.msg["contents"]["drinks"]["cans"]["rootbeer"] = random.randint(1,10)
    
  # drinks (bottles)
  cm.sprite = cm.msg["contents"]["drinks"]["bottles"]["sprite"] = random.randint(1,10)
  cm.gingerale = cm.msg["contents"]["drinks"]["bottles"]["gingerale"] = random.randint(1,10)
  cm.lemonade = cm.msg["contents"]["drinks"]["bottles"]["lemonade"] = random.randint(1,10)

  # milk
  cm.milk = cm.msg["contents"]["milk"] = [(random.randint(0,6), round(random.uniform(1,10),2)) for j in range(3)]

  # bread
  cm.bread = cm.msg["contents"]["bread"] = [(random.randint(0,4), round(random.uniform(1,10),2)) for j in range(3)]
        
  # meat
  cm.meat = cm.msg["contents"]["meat"] = [(random.randint(0,4), round(random.uniform(1,10),2)) for j in range(5)]
  
  cm_h.dispenser = cm_h.msg["contents"]["dispenser"] = random.randint(0,2)
  cm_h.icemaker = cm_h.msg["contents"]["icemaker"] = random.randint(1,100)
  cm_h.lightbulb = cm_h.msg["contents"]["lightbulb"] = random.randint(0,1)
  ...
  cm_h.sensor_status = cm_h.msg["contents"]["sensor_status"] = random.randint(0,1)
  cm_h.capacity_full = cm_h.msg["contents"]["capacity_full"] = random.randint(1,100)
  
  cm_r.order_response = cm_r.msg["contents"]["order_response"] = 0
  cm_r.health_response = cm_r.msg["contents"]["health_response"] = 0
  cm_r.bad_response = cm_r.msg["contents"]["bad_response"] = 1
