...
def Grocery_OrderStart(builder): builder.StartObject(2)
def Start(builder):
    return Grocery_OrderStart(builder)
def Grocery_OrderAddType(builder, type): builder.PrependInt32Slot(0, type, 0)
def AddType(builder, type):
    return Grocery_OrderAddType(builder, type)
def Grocery_OrderAddContents(builder, contents): builder.PrependUOffsetTRelativeSlot(1, flatbuffers.number_types.UOffsetTFlags.py_type(contents), 0)
