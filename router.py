  ...
  while True:
    ...
    if bind_sock in socks:
      ...
      try:
        ...
        #seq_num, dest_ip, dest_port = request.split("~")
        print(f"is this where error is ugh")
        #request = ""
        #seq_num, dest_ip, dest_port, request = request.split("!!!")
        print(f"is this where the error went wrong")
        #seq_num, dest_ip, dest_port, request = request.split("!!!")
