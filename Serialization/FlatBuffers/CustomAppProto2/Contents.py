...
class Contents(object):
    ...
    def Veggies(self):
        ...
        if o != 0:
            x = o + self._tab.Pos
            from CustomAppProto2.Veggies import Veggies
            obj = Veggies()
    ...
    def Drinks(self):
        ...
        if o != 0:
            x = o + self._tab.Pos
            from CustomAppProto2.Drinks import Drinks
            obj = Drinks()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Milk(self, j):
        ...
        if o != 0:
            ...
            from CustomAppProto2.Milk_Order import Milk_Order
            obj = Milk_Order()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Bread(self, j):
        ...
        if o != 0:
            x = self._tab.Vector(o)
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 8
            from CustomAppProto2.Bread_Order import Bread_Order
            obj = Bread_Order()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Meat(self, j):
        ...
        if o != 0:
            x = self._tab.Vector(o)
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 8
            from CustomAppProto2.Meat_Order import Meat_Order
            obj = Meat_Order()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
